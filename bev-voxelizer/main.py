...
class BevVoxelizer:
    ...
    def filter_radius_outliers(self, pcd, nb_points, search_radius):
        '''
    ...
    def generate_bev_voxels(self, pcd_input: o3d.t.geometry.PointCloud) -> o3d.t.geometry.PointCloud:
        ...
        rad_filt_pole, _ = self.filter_radius_outliers(down_pole, nb_points=16, search_radius=0.05)
        rad_filt_stem, _ = self.filter_radius_outliers(down_stem, nb_points=16, search_radius=0.05)
        rad_filt_obstacle, _ = self.filter_radius_outliers(down_obstacle, nb_points=16, search_radius=0.05)
